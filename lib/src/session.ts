import type { CookieSerializeOptions, SessionStorage } from 'solid-start';
import type { CookieParseOptions } from 'solid-start';
import { isSession, type Session } from 'solid-start/session/sessions';
import { z } from 'zod';
